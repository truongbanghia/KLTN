...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-08-06 08:31:13',
                'modified' => '2020-08-06 08:31:13',
            ],
        ];
        parent::init();
    }
